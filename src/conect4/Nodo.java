...
public class Nodo {
	...
	public int valuacionfil(){
        ...
        public int valuacion(){
            ...
            valuacion=valuacion+this.valuacioncol();
            valuacion=valuacion+this.valuacionfil();
            valuacion=valuacion+this.valdiagpos();
            valuacion=valuacion+this.valdiagneg();
            this.setTipo(!tipo);
            valuacion=valuacion-this.posiblesfil();
            valuacion=valuacion-this.posiblescol();
            valuacion=valuacion-this.posiblesdiagneg();
            valuacion=valuacion-this.posiblesdiagpost();
            valuacion=valuacion-this.valuacioncol();
